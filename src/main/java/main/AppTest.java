...
public class AppTest {
    public static void main(String[] args) {
        try {
            ...
            Producto productoPrueba = new Producto(null, false, "Producto Test", "MarcaX", "CategoriaX", 1000.0, 0.5, null);
            productoDao.crear(productoPrueba);
            System.out.println("Producto creado con ID: " + productoPrueba.getId());

            // 2. Crear el código de barras asociado al producto
            String valorUnico = "CB" + System.currentTimeMillis();
            CodigoBarras cb = new CodigoBarras(null, false, TipoCodigo.EAN13, valorUnico,
                    LocalDate.now(), "Producto de prueba", productoPrueba.getId());

            codigoDao.crear(cb);
            System.out.println("Código insertado con ID: " + cb.getId());
